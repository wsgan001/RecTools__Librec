 ...
 */
public class test_similarity {
    protected final static Log LOG = LogFactory.getLog(test_similarity.class);

    public static void main(String[] args) throws Exception {

        System.out.println("Hello World");
        //testRecommender_By_ConfigFile();
        testRecommender_By_ConfigFile_MultiSmilarity();
    }
    ...
    public static void testRecommender_By_ConfigFile_MultiSmilarity() throws ClassNotFoundException, LibrecException, IOException, Exception {
