...
public abstract class AbstractDataConvertor extends ProgressReporter implements DataConvertor {
    ...
    protected HashBasedTable<Integer,Integer,String> splitPredefinedTable;
    ...
    public HashBasedTable<Integer,Integer,String> getSplitPredefinedTable() { return splitPredefinedTable; }
