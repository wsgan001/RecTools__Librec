...
public abstract class AbstractRecommenderEvaluator implements RecommenderEvaluator {
     ...
     */
    public double evaluate(RecommenderContext context, RecommendedList recommendedList, SparseMatrix eval_matrix) {
        ...
        Double test_eval = evaluate(eval_matrix, recommendedList);

//        SparseMatrix trainMatrix = context.getDataModel().getDataSplitter().getTrainData();
//        Double train_eval = evaluate(trainMatrix, recommendedList);
    ...
    public double evaluate(RecommenderContext context, RecommendedList recommendedList) {
        ...
        //return evaluate(testMatrix, recommendedList);
        Double test_eval = evaluate(testMatrix, recommendedList);
